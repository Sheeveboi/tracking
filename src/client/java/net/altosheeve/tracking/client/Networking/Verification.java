...
public class Verification {
    ...
    public  static final String caligulaEndpoint = "97.224.101.131";
    ...
    public static void setToken() throws IOException, InterruptedException, URISyntaxException {
        ...
        if (!tokenFile.exists()) {
            ...
            if (Rendering.client != null) Rendering.client.setScreen(new VerifyScreen(Rendering.client.currentScreen));
        ...
        System.out.println("sending verification to caligula endpoint");
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = Request.get("http://" + Verification.caligulaEndpoint + "/functions", headers, body);
