...
public class Shitter extends Waypoint {
    public Shitter(float x, float y, float z, String UUID, String username) {
        ...
        this.r = Values.yellowColor[0];
        this.g = Values.yellowColor[1];
        this.b = Values.yellowColor[2];
    ...
    public void fill(BufferBuilder buffer) {
        ...
        Circle outercircle = new Circle(0, 0, 0, this.UUID, .6f, 1f);
