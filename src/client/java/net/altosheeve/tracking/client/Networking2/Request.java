...
public class Request extends Thread {
    ...
    public interface RequestCallback {
        void cb(HttpResponse<String> response) throws IOException;
    }
    ...
    private static class RequestFuture extends Thread {
        ...
        public void run() {
            try {
                this.cb.cb(client.send(this.request, HttpResponse.BodyHandlers.ofString()));
    ...
    public static void get(String url, String headers, String body, RequestCallback cb) {
        ...
        HttpRequest.Builder request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .timeout(Duration.ofSeconds(20))
                .method("GET", HttpRequest.BodyPublishers.ofString(b.toString()));
    ...
    public static HttpResponse<String> get(String url, String headers, String body) throws IOException, InterruptedException {
    ...
    public static HttpResponse<String> post(String url, String headers) throws IOException, InterruptedException {
        HttpRequest.Builder request = HttpRequest.newBuilder()
                .uri(URI.create(url))
                .timeout(Duration.ofSeconds(20));
